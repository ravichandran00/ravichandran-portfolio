  ...
  return (
    <div className="xl:mt-12 xl:flex-row flex-col-reverse flex gap-10 overflow-hidden">
         ...
         className="flex-[0.75] bg-black-100 p-8 rounded-2xl">
           ...
           <form
           ref={formRef}
           onClick={handleSubmit} className="mt-12 flex flex-col gap-8">
             ...
             <button
             type="submit" className="bg-tertiary py-3 px-8 outline-one w-fit text-white font-bold shadow-md shadow-primary rounded-xl">
